...
export interface ApiAuthorAuthor extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    title: Schema.Attribute.String &
      ...
      Schema.Attribute.DefaultTo<'Experto en Personalizaci\u00F3n'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiBlogCategoryBlogCategory
  ...
  attributes: {
    ...
    color: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'bg-blue-100 text-blue-800'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiProductoProducto extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    dimensiones: Schema.Attribute.JSON;
    enOferta: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
    ...
    nuevo: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
    ...
    precio: Schema.Attribute.Decimal &
      Schema.Attribute.SetMinMax<
        ...
        number
      >;
    precioDescuento: Schema.Attribute.Decimal &
      Schema.Attribute.SetMinMax<
        {
          min: 0;
        },
    ...
    stock: Schema.Attribute.Integer &
      ...
      > &
      Schema.Attribute.DefaultTo<0>;
    tallas: Schema.Attribute.JSON;
    tecnicasPersonalizacion: Schema.Attribute.Relation<
      'manyToMany',
...
export interface ApiTagTag extends Struct.CollectionTypeSchema {
  collectionName: 'tags';
  info: {
    description: 'Etiquetas para categorizar los art\u00EDculos del blog';
    displayName: 'Tag';
    pluralName: 'tags';
    singularName: 'tag';
  };
  ...
  attributes: {
    ...
    >;
    color: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'bg-gray-100 text-gray-800'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    description: Schema.Attribute.Text &
...
export interface ApiTecnicaPersonalizacionTecnicaPersonalizacion
  extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    cantidadOptima: Schema.Attribute.Integer &
      Schema.Attribute.SetMinMax<
        {
          min: 1;
        },
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    descripcion: Schema.Attribute.RichText & Schema.Attribute.Required;
    desventajas: Schema.Attribute.JSON;
    galeria: Schema.Attribute.Media<'images', true>;
    imagen: Schema.Attribute.Media<'images'>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
    ...
    seo: Schema.Attribute.Component<'shared.seo', false>;
    slug: Schema.Attribute.UID<'nombre'> & Schema.Attribute.Required;
    tiempoProduccion: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ventajas: Schema.Attribute.JSON;
  };
}
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::tecnica-personalizacion.tecnica-personalizacion': ApiTecnicaPersonalizacionTecnicaPersonalizacion;
